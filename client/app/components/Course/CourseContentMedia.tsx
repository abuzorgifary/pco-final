  ...
  const handleQuestion = () => {
    if (question.length === 0) {
      ...
      addNewQuestion({
        question,
        courseId: id,
        contentId: data[activeContent.index]._id,
      });
    }
  };
      ...
      <div className="w-[95%] 800px:w-[86%] py-4 m-auto">
        {activeContent.type === "video" ? (
          <>
            <CoursePlayer
              ...
              videoUrl={data[activeContent.index]?.videoUrl}
            />
            <div className="w-full flex items-center justify-between my-3">
              <div
                className={`${
                  ...
                  activeContent.index === 0 && "!cursor-no-drop opacity-[.8]"
                }`}
                onClick={() =>
                  setActiveContent((activeContent) => ({
                    ...activeContent,
                    index:
                      activeContent.index === 0 ? 0 : activeContent.index - 1,
                  }))
                }
              >
              ...
              <div
                className={`${
                  ...
                  data.length - 1 === activeContent.index &&
                ...
                onClick={() =>
                  setActiveContent((activeContent) => ({
                    ...activeContent,
                    index:
                      data && data.length - 1 === activeContent.index
                        ? activeContent.index
        ...
        {activeBar === 0 && (
          <p className="text-[18px] whitespace-pre-line mb-3 dark:text-white text-black">
            {data[activeContent.index]?.description}
          </p>
        )}

        {activeBar === 1 && (
          <div>
            {data[activeContent.index]?.links.map(
        ...
        {activeBar === 2 && (
          <>
            ...
            <div>
              <CommentReply
                data={data}
                activeVideo={activeContent.index}
                answer={answer}
                setAnswer={setAnswer}
